<?php
namespace Opencart\Admin\Controller\Extension\TelrOc\Payment;
class Telr extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'	=> $this->url->link('extension/telr_oc/payment/telr', 'user_token=' . $this->session->data['user_token'], true),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/telr_oc/payment/telr', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/telr_oc/payment/telr', $data));
	}

	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/telr_oc/payment/telr')) {
